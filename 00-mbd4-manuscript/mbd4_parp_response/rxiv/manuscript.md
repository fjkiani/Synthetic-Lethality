...
abstract: |
  ...
  (LN_IC50 Δ=−0.74, p=0.021, Cohen's d=−0.50; n=14 True-LOF vs 942 WT; GDSC2), a finding that
...
MBD4 True-LOF cell lines (n=14, LikelyLoF=True; DepMap 24Q2) exhibited significantly enhanced sensitivity to ceralasertib (AZD6738), an ATR inhibitor, compared to wild-type lines (n=942) across all three GDSC2 metrics (@fig:volcano):
...
The WEE1 inhibitor adavosertib (MK-1775) showed a consistent but sub-significant trend (LN_IC50 Δ=−0.512, p=0.074, Cohen's d=−0.36, n=15 LOF vs 929 WT), suggesting the vulnerability may extend to the broader replication stress checkpoint axis.
...
**Stress Test 1: MSI-H Ghost Purge (MSI-exclusion sensitivity analysis).** Six of 21 MBD4-LOF lines carry microsatellite instability (MSI-H), which independently sensitizes to checkpoint inhibitors. After removing all MSI-H lines from both groups, the MBD4-LOF signal *strengthened* (n=10 MSS/MBD4-LOF vs n=934 WT, LN_IC50 Δ=−0.913, p=0.015, Cohen's d=−0.623). This suggests that the ATRi sensitivity is unlikely to be an MSI-H proxy.
